...
const initialCommands = [
  ...
  {
    id: randomUUID(),
    title: "Sprawdź temperaturę CPU",
    command: "sensors",
    category: "system",
    description: "Wyświetl temperatury czujników systemowych",
    explanation: "Pokazuje temperatury procesora, płyty głównej i innych czujników. Wymaga pakietu lm-sensors.",
    parameters: [
      { flag: "sensors", description: "Hardware monitoring sensors" }
    ] as CommandParameter[],
    keywords: ["sensors", "temperatura", "cpu", "temp", "monitoring", "hardware", "czujniki"]
  },
  {
    id: randomUUID(),
    title: "Monitoruj temperatura w czasie rzeczywistym",
    command: "watch -n 1 sensors",
    category: "system",
    description: "Odświeżaj temperatury co sekundę",
    explanation: "Używa polecenia watch do ciągłego odświeżania wyników sensors co 1 sekundę.",
    parameters: [
      { flag: "watch", description: "Wykonuj polecenie cyklicznie" },
      { flag: "-n 1", description: "Interwał 1 sekunda" },
      { flag: "sensors", description: "Polecenie do wykonania" }
    ] as CommandParameter[],
    keywords: ["watch", "sensors", "temperatura", "monitor", "real-time", "czas rzeczywisty"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź obciążenie dysków I/O",
    command: "iostat -x 1",
    category: "system",
    description: "Monitoruj statystyki wejścia/wyjścia dysków",
    explanation: "Wyświetla rozszerzone statystyki I/O dla wszystkich dysków, odświeżane co sekundę.",
    parameters: [
      { flag: "iostat", description: "Input/Output statistics" },
      { flag: "-x", description: "Extended statistics - rozszerzone statystyki" },
      { flag: "1", description: "Interwał 1 sekunda" }
    ] as CommandParameter[],
    keywords: ["iostat", "io", "dysk", "disk", "performance", "statistics", "statystyki"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź partycje dysku",
    command: "lsblk",
    category: "system",
    description: "Wyświetl strukturę urządzeń blokowych",
    explanation: "Pokazuje wszystkie dyski i partycje w formie drzewa wraz z punktami montowania i rozmiarami.",
    parameters: [
      { flag: "lsblk", description: "List block devices - lista urządzeń blokowych" }
    ] as CommandParameter[],
    keywords: ["lsblk", "partycje", "dyski", "block", "devices", "partitions", "mount"]
  },
  {
    id: randomUUID(),
    title: "Wyświetl szczegóły partycji",
    command: "fdisk -l",
    category: "system",
    description: "Pokaż szczegółowe informacje o partycjach",
    explanation: "Wyświetla szczegółowe informacje o wszystkich partycjach na dyskach. Wymaga uprawnień root.",
    parameters: [
      { flag: "fdisk", description: "Fixed disk utility" },
      { flag: "-l", description: "List partitions - lista partycji" }
    ] as CommandParameter[],
    keywords: ["fdisk", "partycje", "partitions", "disk", "szczegóły", "table", "lista"]
  },
  {
    id: randomUUID(),
    title: "Stwórz link symboliczny",
    command: "ln -s /path/to/original /path/to/link",
    category: "files",
    description: "Utwórz link symboliczny do pliku lub katalogu",
    explanation: "Tworzy link symboliczny (dowiązanie) do istniejącego pliku lub katalogu. Link symboliczny to wskaźnik na inny plik.",
    parameters: [
      { flag: "ln", description: "Create links - twórz linki" },
      { flag: "-s", description: "Symbolic link - link symboliczny" },
      { flag: "/path/to/original", description: "Ścieżka do oryginalnego pliku" },
      { flag: "/path/to/link", description: "Ścieżka nowego linku" }
    ] as CommandParameter[],
    keywords: ["ln", "link", "symbolic", "dowiązanie", "symlink", "shortcut", "skrót"]
  },
  {
    id: randomUUID(),
    title: "Znajdź pliki według typu",
    command: "find /path -type f -name '*.log'",
    category: "files",
    description: "Wyszukaj pliki według typu i wzorca nazwy",
    explanation: "Znajduje wszystkie pliki (-type f) pasujące do wzorca nazwy w określonym katalogu i podkatalogach.",
    parameters: [
      { flag: "find", description: "Wyszukiwanie plików" },
      { flag: "/path", description: "Ścieżka do przeszukania" },
      { flag: "-type f", description: "Tylko zwykłe pliki" },
      { flag: "-name '*.log'", description: "Wzorzec nazwy" }
    ] as CommandParameter[],
    keywords: ["find", "type", "pattern", "wzorzec", "log", "pliki", "search", "extension"]
  },
  {
    id: randomUUID(),
    title: "Znajdź katalogi według nazwy",
    command: "find /path -type d -name 'backup*'",
    category: "files",
    description: "Wyszukaj katalogi pasujące do wzorca",
    explanation: "Znajduje wszystkie katalogi (-type d) których nazwa zaczyna się od 'backup'.",
    parameters: [
      { flag: "find", description: "Wyszukiwanie" },
      { flag: "/path", description: "Ścieżka przeszukiwania" },
      { flag: "-type d", description: "Tylko katalogi" },
      { flag: "-name 'backup*'", description: "Wzorzec nazwy" }
    ] as CommandParameter[],
    keywords: ["find", "directory", "katalog", "folder", "backup", "wzorzec", "pattern"]
  },
  {
    id: randomUUID(),
    title: "Usuń pliki starsze niż 7 dni",
    command: "find /path -type f -mtime +7 -delete",
    category: "files",
    description: "Znajdź i usuń stare pliki",
    explanation: "Znajduje pliki starsze niż 7 dni i automatycznie je usuwa. UWAGA: Operacja nieodwracalna!",
    parameters: [
      { flag: "find", description: "Wyszukiwanie plików" },
      { flag: "/path", description: "Ścieżka przeszukiwania" },
      { flag: "-type f", description: "Tylko pliki" },
      { flag: "-mtime +7", description: "Starsze niż 7 dni" },
      { flag: "-delete", description: "Usuń znalezione pliki" }
    ] as CommandParameter[],
    keywords: ["find", "delete", "usuń", "stare", "old", "cleanup", "czyszczenie", "mtime"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź suma kontrolna MD5",
    command: "md5sum file.txt",
    category: "files",
    description: "Oblicz sumę kontrolną MD5 pliku",
    explanation: "Generuje sumę kontrolną MD5 dla pliku. Przydatne do weryfikacji integralności plików.",
    parameters: [
      { flag: "md5sum", description: "MD5 checksum calculator" },
      { flag: "file.txt", description: "Plik do sprawdzenia" }
    ] as CommandParameter[],
    keywords: ["md5sum", "checksum", "suma kontrolna", "hash", "integrity", "weryfikacja"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź suma kontrolna SHA256",
    command: "sha256sum file.txt",
    category: "files",
    description: "Oblicz sumę kontrolną SHA256 pliku",
    explanation: "Generuje bezpieczniejszą sumę kontrolną SHA256. Zalecana zamiast MD5 do celów bezpieczeństwa.",
    parameters: [
      { flag: "sha256sum", description: "SHA256 checksum calculator" },
      { flag: "file.txt", description: "Plik do sprawdzenia" }
    ] as CommandParameter[],
    keywords: ["sha256sum", "checksum", "suma kontrolna", "hash", "security", "bezpieczeństwo"]
  },
  {
    id: randomUUID(),
    title: "Porównaj zawartość plików",
    command: "diff file1.txt file2.txt",
    category: "files",
    description: "Porównaj różnice między plikami",
    explanation: "Wyświetla różnice między dwoma plikami linia po linii. Pokazuje co zostało dodane, usunięte lub zmienione.",
    parameters: [
      { flag: "diff", description: "Compare files line by line" },
      { flag: "file1.txt", description: "Pierwszy plik" },
      { flag: "file2.txt", description: "Drugi plik" }
    ] as CommandParameter[],
    keywords: ["diff", "porównaj", "compare", "różnice", "changes", "pliki", "files"]
  },
  {
    id: randomUUID(),
    title: "Zsynchronizuj katalogi",
    command: "rsync -av /source/ /destination/",
    category: "files",
    description: "Synchronizuj pliki między katalogami",
    explanation: "Synchronizuje zawartość katalogów. Opcja -a zachowuje atrybuty, -v pokazuje szczegóły operacji.",
    parameters: [
      { flag: "rsync", description: "Remote/local file synchronization" },
      { flag: "-a", description: "Archive mode - tryb archiwum" },
      { flag: "-v", description: "Verbose - szczegółowy output" },
      { flag: "/source/", description: "Katalog źródłowy" },
      { flag: "/destination/", description: "Katalog docelowy" }
    ] as CommandParameter[],
    keywords: ["rsync", "sync", "synchronizuj", "backup", "mirror", "copy", "pliki"]
  },
  {
    id: randomUUID(),
    title: "Monitoruj zmiany w pliku na żywo",
    command: "tail -f /var/log/syslog | grep ERROR",
    category: "system",
    description: "Śledź logi i filtruj błędy",
    explanation: "Monitoruje plik logu w czasie rzeczywistym i pokazuje tylko linie zawierające 'ERROR'.",
    parameters: [
      { flag: "tail -f", description: "Follow file changes" },
      { flag: "/var/log/syslog", description: "Ścieżka do pliku logu" },
      { flag: "|", description: "Pipe - przekaż wynik dalej" },
      { flag: "grep ERROR", description: "Filtruj linie z 'ERROR'" }
    ] as CommandParameter[],
    keywords: ["tail", "grep", "error", "log", "monitor", "real-time", "filter", "błędy"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź otwarte pliki w systemie",
    command: "lsof | wc -l",
    category: "system",
    description: "Policz wszystkie otwarte pliki",
    explanation: "Wyświetla liczbę wszystkich otwartych plików w systemie. Każdy proces może mieć otwarte różne pliki.",
    parameters: [
      { flag: "lsof", description: "List open files" },
      { flag: "|", description: "Pipe" },
      { flag: "wc -l", description: "Count lines" }
    ] as CommandParameter[],
    keywords: ["lsof", "open files", "count", "system", "procesy", "pliki otwarte"]
  },
  {
    id: randomUUID(),
    title: "Wyświetl zmienne PATH",
    command: "echo $PATH | tr ':' '\\n'",
    category: "system",
    description: "Pokaż wszystkie ścieżki w PATH",
    explanation: "Wyświetla każdą ścieżkę ze zmiennej PATH w osobnej linii dla lepszej czytelności.",
    parameters: [
      { flag: "echo $PATH", description: "Wyświetl zmienną PATH" },
      { flag: "|", description: "Pipe" },
      { flag: "tr ':' '\\n'", description: "Zamień : na nowe linie" }
    ] as CommandParameter[],
    keywords: ["path", "environment", "variables", "ścieżki", "echo", "tr"]
  },
  {
    id: randomUUID(),
    title: "Uruchom polecenie z timeout",
    command: "timeout 30s ping google.com",
    category: "system",
    description: "Ogranicz czas wykonania polecenia",
    explanation: "Uruchamia polecenie z limitem czasu 30 sekund. Po przekroczeniu czasu proces zostanie zakończony.",
    parameters: [
      { flag: "timeout", description: "Run command with time limit" },
      { flag: "30s", description: "Limit czasowy 30 sekund" },
      { flag: "ping google.com", description: "Polecenie do wykonania" }
    ] as CommandParameter[],
    keywords: ["timeout", "limit", "czas", "time", "kill", "process", "seconds"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź załadowane moduły jądra",
    command: "lsmod",
    category: "system",
    description: "Wyświetl aktywne moduły jądra Linux",
    explanation: "Pokazuje wszystkie załadowane moduły jądra wraz z informacjami o zależnościach i użyciu.",
    parameters: [
      { flag: "lsmod", description: "List kernel modules" }
    ] as CommandParameter[],
    keywords: ["lsmod", "kernel", "modules", "jądro", "moduły", "drivers", "sterowniki"]
  },
  {
    id: randomUUID(),
    title: "Załaduj moduł jądra",
    command: "sudo modprobe module_name",
    category: "system",
    description: "Załaduj moduł jądra Linux",
    explanation: "Ładuje określony moduł jądra wraz z jego zależnościami. Wymaga uprawnień root.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "modprobe", description: "Module probe - ładowanie modułów" },
      { flag: "module_name", description: "Nazwa modułu do załadowania" }
    ] as CommandParameter[],
    keywords: ["modprobe", "load", "module", "kernel", "załaduj", "moduł", "driver"]
  },
  {
    id: randomUUID(),
    title: "Usuń moduł jądra",
    command: "sudo modprobe -r module_name",
    category: "system",
    description: "Odłącz moduł jądra",
    explanation: "Usuwa określony moduł jądra z pamięci. Moduł musi nie być używany przez inne procesy.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "modprobe", description: "Module management" },
      { flag: "-r", description: "Remove - usuń moduł" },
      { flag: "module_name", description: "Nazwa modułu do usunięcia" }
    ] as CommandParameter[],
    keywords: ["modprobe", "remove", "unload", "module", "usuń", "moduł", "kernel"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź informacje o USB",
    command: "lsusb",
    category: "system",
    description: "Wyświetl urządzenia USB",
    explanation: "Pokazuje wszystkie podłączone urządzenia USB wraz z identyfikatorami i opisami.",
    parameters: [
      { flag: "lsusb", description: "List USB devices" }
    ] as CommandParameter[],
    keywords: ["lsusb", "usb", "devices", "urządzenia", "hardware", "sprzęt"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź urządzenia PCI",
    command: "lspci",
    category: "system",
    description: "Wyświetl urządzenia PCI",
    explanation: "Pokazuje wszystkie urządzenia podłączone do magistrali PCI, w tym karty graficzne, sieciowe, dźwiękowe.",
    parameters: [
      { flag: "lspci", description: "List PCI devices" }
    ] as CommandParameter[],
    keywords: ["lspci", "pci", "hardware", "devices", "urządzenia", "cards", "karty"]
  },
  {
    id: randomUUID(),
    title: "Wyświetl informacje o baterii",
    command: "upower -i /org/freedesktop/UPower/devices/BAT0",
    category: "system",
    description: "Sprawdź status baterii laptopa",
    explanation: "Wyświetla szczegółowe informacje o baterii: poziom naładowania, stan, czas do rozładowania.",
    parameters: [
      { flag: "upower", description: "UPower battery information" },
      { flag: "-i", description: "Info - informacje" },
      { flag: "/org/freedesktop/UPower/devices/BAT0", description: "Ścieżka do baterii" }
    ] as CommandParameter[],
    keywords: ["upower", "battery", "bateria", "laptop", "charging", "power", "energia"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź wszystkie urządzenia energetyczne",
    command: "upower -l",
    category: "system",
    description: "Lista wszystkich urządzeń energetycznych",
    explanation: "Wyświetla wszystkie urządzenia zarządzające energią: baterie, zasilacze, UPS.",
    parameters: [
      { flag: "upower", description: "Power management" },
      { flag: "-l", description: "List - lista urządzeń" }
    ] as CommandParameter[],
    keywords: ["upower", "power", "devices", "energy", "energia", "ups", "battery"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź pamięć swap",
    command: "swapon --show",
    category: "system",
    description: "Wyświetl informacje o pamięci swap",
    explanation: "Pokazuje wszystkie aktywne partycje swap wraz z ich rozmiarami i priorytetami.",
    parameters: [
      { flag: "swapon", description: "Swap management" },
      { flag: "--show", description: "Show active swaps" }
    ] as CommandParameter[],
    keywords: ["swapon", "swap", "memory", "pamięć", "virtual", "paging", "partycja"]
  },
  {
    id: randomUUID(),
    title: "Utwórz plik swap",
    command: "sudo fallocate -l 2G /swapfile",
    category: "system",
    description: "Stwórz plik wymiany o rozmiarze 2GB",
    explanation: "Tworzy plik swap o określonym rozmiarze. Po utworzeniu trzeba go jeszcze aktywować komendą mkswap i swapon.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "fallocate", description: "Allocate space for file" },
      { flag: "-l 2G", description: "Length - rozmiar 2GB" },
      { flag: "/swapfile", description: "Ścieżka pliku swap" }
    ] as CommandParameter[],
    keywords: ["fallocate", "swap", "create", "utwórz", "memory", "virtual", "file"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź montowane systemy plików",
    command: "mount | column -t",
    category: "system",
    description: "Wyświetl zamontowane systemy plików w tabeli",
    explanation: "Pokazuje wszystkie zamontowane systemy plików w czytelnym formacie tabeli.",
    parameters: [
      { flag: "mount", description: "Show mounted filesystems" },
      { flag: "|", description: "Pipe" },
      { flag: "column -t", description: "Format as table" }
    ] as CommandParameter[],
    keywords: ["mount", "filesystem", "mounted", "partitions", "tabela", "column"]
  },
  {
    id: randomUUID(),
    title: "Zamontuj urządzenie",
    command: "sudo mount /dev/sdb1 /mnt/usb",
    category: "system",
    description: "Zamontuj partycję w określonym punkcie",
    explanation: "Montuje partycję /dev/sdb1 w katalogu /mnt/usb. Katalog docelowy musi istnieć.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "mount", description: "Mount filesystem" },
      { flag: "/dev/sdb1", description: "Urządzenie do zamontowania" },
      { flag: "/mnt/usb", description: "Punkt montowania" }
    ] as CommandParameter[],
    keywords: ["mount", "usb", "partition", "filesystem", "zamontuj", "device"]
  },
  {
    id: randomUUID(),
    title: "Odmontuj urządzenie",
    command: "sudo umount /mnt/usb",
    category: "system",
    description: "Bezpiecznie odmontuj system plików",
    explanation: "Odmontowuje system plików z określonego punktu montowania. Wszystkie pliki muszą być zamknięte.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "umount", description: "Unmount filesystem" },
      { flag: "/mnt/usb", description: "Punkt montowania do odmontowania" }
    ] as CommandParameter[],
    keywords: ["umount", "unmount", "odmontuj", "safely", "bezpiecznie", "eject"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź który proces używa pliku",
    command: "fuser -v /path/to/file",
    category: "processes",
    description: "Znajdź procesy używające określonego pliku",
    explanation: "Wyświetla wszystkie procesy które aktualnie używają określonego pliku lub katalogu.",
    parameters: [
      { flag: "fuser", description: "File user identification" },
      { flag: "-v", description: "Verbose - szczegółowe info" },
      { flag: "/path/to/file", description: "Ścieżka do pliku" }
    ] as CommandParameter[],
    keywords: ["fuser", "file", "process", "używa", "busy", "locked", "procesy"]
  },
  {
    id: randomUUID(),
    title: "Wymuś odmontowanie",
    command: "sudo fuser -km /mnt/usb",
    category: "system",
    description: "Zabij procesy i wymusi odmontowanie",
    explanation: "Zabija wszystkie procesy używające punktu montowania i wymusza odmontowanie. Używaj ostrożnie!",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "fuser", description: "File user management" },
      { flag: "-k", description: "Kill processes" },
      { flag: "-m", description: "Mount point" },
      { flag: "/mnt/usb", description: "Punkt montowania" }
    ] as CommandParameter[],
    keywords: ["fuser", "kill", "force", "unmount", "wymusi", "processes", "busy"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź błędy systemu plików",
    command: "sudo fsck /dev/sdb1",
    category: "system",
    description: "Skanuj i napraw system plików",
    explanation: "Sprawdza integralność systemu plików i naprawia znalezione błędy. Urządzenie musi być odmontowane.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "fsck", description: "File system check" },
      { flag: "/dev/sdb1", description: "Partycja do sprawdzenia" }
    ] as CommandParameter[],
    keywords: ["fsck", "check", "repair", "filesystem", "errors", "błędy", "naprawa"]
  },
  {
    id: randomUUID(),
    title: "Formatuj partycję na ext4",
    command: "sudo mkfs.ext4 /dev/sdb1",
    category: "system",
    description: "Sformatuj partycję na system plików ext4",
    explanation: "Tworzy nowy system plików ext4 na określonej partycji. UWAGA: Usuwa wszystkie dane!",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "mkfs.ext4", description: "Make ext4 filesystem" },
      { flag: "/dev/sdb1", description: "Partycja do sformatowania" }
    ] as CommandParameter[],
    keywords: ["mkfs", "format", "ext4", "filesystem", "partition", "formatuj", "create"]
  },
  {
    id: randomUUID(),
    title: "Pokaż aktywne połączenia sieciowe",
    command: "ss -tuln",
    category: "network",
    description: "Wyświetl nasłuchujące porty TCP i UDP",
    explanation: "Nowoczesna alternatywa dla netstat. Pokazuje porty TCP (-t) i UDP (-u) w trybie nasłuchiwania (-l) z adresami numerycznymi (-n).",
    parameters: [
      { flag: "ss", description: "Socket statistics" },
    ...
    keywords: ["ss", "netstat", "network", "tcp", "udp", "listening", "ports", "porty"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź routing table",
    command: "ip route show",
    category: "network",
    description: "Wyświetl tablę routingu",
    explanation: "Pokazuje wszystkie trasy sieciowe wraz z bramą domyślną i interfejsami sieciowymi.",
    parameters: [
      { flag: "ip", description: "IP utilities" },
      { flag: "route", description: "Routing table operations" },
      { flag: "show", description: "Display routes" }
    ] as CommandParameter[],
    keywords: ["ip", "route", "routing", "gateway", "network", "trasy", "brama"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź interfejsy sieciowe",
    command: "ip link show",
    category: "network",
    description: "Wyświetl interfejsy sieciowe",
    explanation: "Pokazuje wszystkie interfejsy sieciowe (ethernet, wifi, loopback) wraz z ich statusem i adresami MAC.",
    parameters: [
      { flag: "ip", description: "IP utilities" },
      { flag: "link", description: "Network device operations" },
      { flag: "show", description: "Display interfaces" }
    ] as CommandParameter[],
    keywords: ["ip", "link", "interface", "network", "ethernet", "wifi", "mac", "status"]
  },
  {
    id: randomUUID(),
    title: "Restart interfejsu sieciowego",
    command: "sudo ip link set eth0 down && sudo ip link set eth0 up",
    category: "network",
    description: "Restart interfejsu sieciowego",
    explanation: "Wyłącza i ponownie włącza interfejs sieciowy. Przydatne przy problemach z siecią.",
    parameters: [
      { flag: "sudo ip link set eth0 down", description: "Wyłącz interfejs" },
      { flag: "&&", description: "Execute next if successful" },
      { flag: "sudo ip link set eth0 up", description: "Włącz interfejs" }
    ] as CommandParameter[],
    keywords: ["ip", "link", "restart", "interface", "network", "down", "up", "eth0"]
  },
  {
    id: randomUUID(),
    title: "Dodaj statyczną trasę",
    command: "sudo ip route add 192.168.2.0/24 via 192.168.1.1",
    category: "network",
    description: "Dodaj statyczną trasę sieciową",
    explanation: "Dodaje statyczną trasę do sieci 192.168.2.0/24 przez bramę 192.168.1.1.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "ip route add", description: "Add route" },
      { flag: "192.168.2.0/24", description: "Sieć docelowa" },
      { flag: "via 192.168.1.1", description: "Brama (gateway)" }
    ] as CommandParameter[],
    keywords: ["ip", "route", "add", "static", "gateway", "network", "routing"]
  },
  {
    id: randomUUID(),
    title: "Usuń trasę sieciową",
    command: "sudo ip route del 192.168.2.0/24",
    category: "network",
    description: "Usuń trasę z tabeli routingu",
    explanation: "Usuwa określoną trasę sieciową z tabeli routingu systemu.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "ip route del", description: "Delete route" },
      { flag: "192.168.2.0/24", description: "Sieć do usunięcia" }
    ] as CommandParameter[],
    keywords: ["ip", "route", "delete", "remove", "usuń", "routing", "network"]
  },
  {
    id: randomUUID(),
    title: "Skanuj porty hosta",
    command: "nmap -p 1-1000 192.168.1.1",
    category: "network",
    description: "Przeskanuj otwarte porty na hoście",
    explanation: "Skanuje porty 1-1000 na określonym hoście aby znaleźć otwarte usługi. Wymaga pakietu nmap.",
    parameters: [
      { flag: "nmap", description: "Network Mapper" },
      { flag: "-p 1-1000", description: "Port range to scan" },
      { flag: "192.168.1.1", description: "Target host IP" }
    ] as CommandParameter[],
    keywords: ["nmap", "scan", "ports", "security", "network", "host", "services"]
  },
  {
    id: randomUUID(),
    title: "Sprawdź DNS lookup",
    command: "nslookup google.com",
    category: "network",
    description: "Sprawdź rozwiązywanie nazw DNS",
    explanation: "Wyświetla informacje DNS dla określonej domeny, w tym adresy IP i serwery nazw.",
    parameters: [
      { flag: "nslookup", description: "Name server lookup" },
      { flag: "google.com", description: "Domain to lookup" }
    ] as CommandParameter[],
    keywords: ["nslookup", "dns", "domain", "lookup", "ip", "nameserver", "resolving"]
  },
  {
    id: randomUUID(),
    title: "Wyczyść cache DNS",
    command: "sudo systemctl flush-dns",
    category: "network",
    description: "Wyczyść lokalny cache DNS",
    explanation: "Czyści lokalny cache DNS, zmuszając system do ponownego pobrania rekordów DNS.",
    parameters: [
      { flag: "sudo", description: "Uprawnienia administratora" },
      { flag: "systemctl", description: "System control" },
      { flag: "flush-dns", description: "Clear DNS cache" }
    ] as CommandParameter[],
    keywords: ["systemctl", "flush", "dns", "cache", "clear", "wyczyść", "refresh"]
  },
  {
    id: randomUUID(),
    title: "Testuj przepustowość sieci",
    command: "iperf3 -c server.example.com",
    category: "network",
    description: "Przetestuj prędkość połączenia sieciowego",
    explanation: "Testuje przepustowość sieci do serwera iperf3. Serwer musi mieć uruchomiony iperf3 w trybie serwera.",
    parameters: [
      { flag: "iperf3", description: "Network performance testing" },
      { flag: "-c", description: "Client mode" },
      { flag: "server.example.com", description: "Server address" }
    ] as CommandParameter[],
    keywords: ["iperf3", "network", "speed", "bandwidth", "performance", "test", "przepustowość"]
  }
];

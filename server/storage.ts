  ...
  private initializeCommands() {
    const initialCommands: Command[] = [
      ...
      },
      {
        ...
        keywords: ["nano", "edytor", "edit", "plik", "tekst", "terminal"]
      },
      {
        id: randomUUID(),
      ...
      },
      {
        ...
        command: "who",
        category: "system",
        description: "Pokaż aktywne sesje użytkowników",
        explanation: "Wyświetla wszystkich zalogowanych użytkowników, w tym sesje SSH, z informacją o czasie logowania.",
        parameters: [
          { flag: "who", description: "Zalogowani użytkownicy" }
        ],
        keywords: ["who", "ssh", "sesje", "zalogowani", "users", "active"]
      },
      {
        id: randomUUID(),
